...
public interface IHaptics
{
	 ...
	 */
	void triggerHapticPulse(EnumController hand, float durationSeconds, float frequency, float amplitude);

	/**
	 * Queues haptics pulse to happen on a given hand after some time.
	 * Use {@link #DEFAULT_FREQUENCY} to give vivecraft-like feel to it.
	 */
	void queueHapticPulse(EnumController hand, float durationSeconds, float frequency, float amplitude, float delaySeconds);
}